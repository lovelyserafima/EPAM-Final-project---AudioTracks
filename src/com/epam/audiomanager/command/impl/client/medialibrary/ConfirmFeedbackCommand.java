package com.epam.audiomanager.command.impl.client.medialibrary;
...
public class ConfirmFeedbackCommand implements Command {
    ...
    public Router execute(HttpServletRequest httpServletRequest) throws ProjectException {
        ...
        String reply = Validation.replaceScript(httpServletRequest.getParameter(ConstantAttributes.REPLY));
