                ...
                <form action="/controller" method="post">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <th><input type="number" name="year" value="${audioTrack.year}" required/></th>
                            <th><p class="text-danger">${wrongYear}</p></th>
                        </tr>
                        <tr>
                            <th><fmt:message key="label.price"/></th>
                            <th><input type="number" name="price" value="${audioTrack.price}" required/></th>
                        ...
                        <tr>
                            ...
                            <th>
                                <input type="text" name="demoAudioPath" value="${audioTrack.demoAudioPath}" required/>
                            </th>
                        </tr>
                        <tr>
                            ...
                            <th>
                                <input type="text" name="fullAudioPath" value="${audioTrack.fullAudioPath}" required/>
                            </th>
                        </tr>
                        </tbody>
                    </table>
                    <button type="submit" name="command" value="Confirm editing audio">
