...
<html>
<head>
    <title><fmt:message key="label.addNewTrack"/></title>
    <meta charset="utf-8">
            ...
            <div class="well">
                <form action="/controller" method="post">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <th><fmt:message key="label.enterPathToFullAudio"/></th>
                            <th><input type="text" name="fullAudioPath" required/></th>
                        </tr>
                        <tr>
                            <th><fmt:message key="label.enterPathToDemoAudio"/></th>
                            <th><input type="text" name="demoAudioPath" required/></th>
                        </tr>
                        <p class="text-danger">${alreadyExistingTrack}</p>
                        </tbody>
                    </table>
                    <button type="submit" name="command" value="Confirm adding audio">
