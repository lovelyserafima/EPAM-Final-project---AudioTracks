...
<html>
<head>
    <title><fmt:message key="label.mediaLibrary"/></title>
    <meta charset="utf-8">
        ...
        <div class="col-sm-9">
            <div class="well">
                <form action="/controller" method="post">
                    <h4><fmt:message key="label.yourTracks"/></h4>
                    <p class="text-danger">${noTracks}</p>
                    <p class="text-danger">${badResultOfReply}</p>
                    <p class="text-success">${goodResultOfReply}</p>
                    <table class="table">
                        ...
                        <c:forEach items="${requestScope.audioTracks}" var="audioTrack">
                            <tr>
                                ...
                                <td><a href="/controller?command=Give feedback&trackId=${audioTrack.id}">
